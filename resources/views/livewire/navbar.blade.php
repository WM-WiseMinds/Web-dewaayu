<div class="navbar bg-gradient-to-t from-purple-800 to-violet-600">
    <div class="navbar-start">
        <div class="dropdown">
            ...
            <ul tabindex="0"
                ...
                <li><a href="{{ url('/beritas') }}">Berita</a></li>
            </ul>
        </div>
        <a class="btn btn-ghost text-xl text-white">Sekretariat TAPM</a>
    </div>
