            ...
            <div class="">
                <div class="mb-4">
                    ...
                    <div class="flex items-center">
                        <input type="radio" wire:model="recipientType" wire:change="updateRecipientType" value="internal"
                            id="internal" class="mr-2">
                ...
                @if ($jenis_surat == 'keluar')
                    ...
                    <div class="mb-4">
                        <label for="penerima_id"
                            class="block text
                    -gray-700 text-sm font-bold mb-2">Penerima</label>
                    ...
                    <div class="mb-4">
                        <label for="rekomendasi_id"
                            class="block text
                    -gray-700 text-sm font-bold mb-2">Rekomendasi
                            TAPM</label>
