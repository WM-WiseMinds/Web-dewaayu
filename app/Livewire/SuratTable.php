...
final class SuratTable extends PowerGridComponent
{
    ...
    {
        return Surat::query()
            ->leftJoin('users', 'surat.user_id', '=', 'users.id')
            ->select('surat.*', 'users.name as name','users.no_hp as no_hp','users.alamat as alamat')
        ;
    ...
    {
        return ['users'=> ['name','no_hp','alamat']
        ];
    }
    ...
    public function columns(): array
    {
        return [
            ...
            // Column::make('Jam Kegiatan','jam_kegiatan')
            //     ->searchable()
            //     ->sortable(),
