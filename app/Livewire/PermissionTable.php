...
final class PermissionTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        if (auth()->user()->can('export')) {
            $setUp[] = Exportable::make('permission')
                ->striped()
    ...
    public function actions(Permission $row): array
    {
        ...
        if (auth()->user()->can('update')) {
            ...
            ')
                ...
                ->openModal('permission-form', ['rowId' => $row->id]);
        }
    ...
    public function header(): array
    {
        ...
        if (auth()->user()->can('create')) {
            $header[] = Button::add('add-permissions')
    ...
    public function exportPdf()
    {
        ...
        // Membuat file pdf
        $pdf = Pdf::loadView('pdf.permission', ['datasource' => $datasource]);
        // Menyimpan file pdf ke folder pdf
        $pdf->save($path . '/permission.pdf');
        // Menampilkan file pdf
        return response()->download($path . '/permission.pdf');
    }
