...
final class DesaTable extends PowerGridComponent
{
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ->add('id')
            ->add('user_id')
            ->add('nama_user', fn ($row) => $row->user->name)
            ->add('nama_desa')
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Nama Desa', 'nama_desa')
                ->sortable()
                ->searchable(),
            Column::make('Nama Sekretaris Desa', 'nama_user')
                ->searchable(),
    ...
    public function actions(Desa $row): array
    {
        $actions = [];
        ...
        if (auth()->user()->can('update')) {
            ...
            ')
                ...
                ->openModal('desa-form', ['rowId' => $row->id]);
        }
